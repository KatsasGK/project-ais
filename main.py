...
# HACKER MODE HERE --- USE IT AT YOUR OWN RISK
def hackermode():
    return

# HACKER MODE ENDS HERE --- USE IT AT YOUR OWN RISK
...
def weather():
    def tommorrow_weather1():
        ...
        if avg > 32:
            ...
            if day_night_diff > 7:
                print(
                    "Hmm... i see it's going to be a bit cold outside and i expect high difference between day to night so be cautius")
            elif day_night_diff < 7:
                print(
                    "Hmm... i see it's going to be a bit cold outside but dont expect high difference between day to night, be cautius")
        elif avg < 13 and avg > 6:
            if day_night_diff > 7:
                print(
                    "WARNING the weather is going to be really cold and watch out because high difference between day and night is expected")
            elif day_night_diff < 7:
                print(
                    "WARNING the weather is going to be really cold but it won't have high difference between day and night")
        elif avg < 6:
            print(
                "WARNING the weather is going to be extremelly cold.... Is it so important afterall? Or are you visiting a mountain?")
...
### WEATHER CALCULATIONS END HERE-----------------------------

# BASIC FUNCTIONS FOR THE TODO LIST---------------------------
todos = []
def todo_show():
...
def todo_remove():
    ...
    if idx < len(todos):
        print(f"Removing {todos.index[idx]}")
        todos.pop(idx)
    else:
        print("There is no Todo at this position")

# BASIC FUNCTIONS FOR THE TODO LIST END HERE-------------------
